...
(function (toscad) {
    ...
    */
    ...
    function renumberHelices(grid, helixPos, lattice = 'honeycomb') {
        ...
        console.log(`[renumberHelices] n=${n}, components=${nComps}, ` +
    ...
    toscad.renumberHelices = renumberHelices;
    /**
