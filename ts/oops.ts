...
let scadnanoOrigin: string | null = null; // origin for postMessage handshakes with scadnano
let oxviewOrigin: string | null = null; // origin for postMessage handshakes with scadnano
